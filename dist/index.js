...
var i = (r, t, e) => (R(r, typeof t != "symbol" ? t + "" : t, e), e), P = (r, t, e) => {
  if (!t.has(r))
  ...
  constructor(t = '[data-tabs="wrapper"]', { tabbuttonsListSelector: e = '[data-tabs="tabs"]', tabpanelsListSelector: s = '[data-tabs="content"]', deletableTabs: a = !1, initialTab: n = 0, equalHeight: T = !1, orientation: M = "horizontal", triggerEvent: g = c.click, autoplay: B = {
    ...
    i(this, "assignTabsAttributes", () => {
      ...
      this.tabsWrapper.classList.add(u.TABS_WRAPPER), this.tabsWrapper.setAttribute("aria-orientation", this.orientation), (t = this.tabButtonsList) == null || t.classList.add(u.TAB_LIST), (e = this.tabPanelsList) == null || e.classList.add(u.PANEL_LIST), this.panels.forEach((s, a) => {
        this.tabs[a] && (this.tabs[a].classList.add(u.TAB), this.tabs[a].setAttribute("aria-label", `${a}`), this.tabs[a].setAttribute("role", h(this, E).tab), this.tabs[a].setAttribute("id", `${this.generatedId}-tab-${a}`), this.tabs[a].setAttribute("aria-controls", `${this.generatedId}-tabpanel-${a}`), this.tabs[a].dataset.deletable = `${h(this, w)}`), s.classList.add(u.PANEL), s.setAttribute("aria-labelledby", `${this.generatedId}-tab-${a}`), s.setAttribute("id", `${this.generatedId}-tabpanel-${a}`), s.setAttribute("aria-label", `${a}`), s.setAttribute("role", h(this, E).tabpanel);
      }), this.setUnactiveAll();
    });
